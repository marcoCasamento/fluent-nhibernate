...
namespace FluentNHibernate.Testing.MappingModel
{
    ...
    public class ClassMappingTester
    {
        ...
        {
            var property = new PropertyMapping(null) { Name = "Property1" };
        ...
        {
            var reference = new ManyToOneMapping(null) { Name = "parent" };
        ...
        {
            var joinedSubclass = new SubclassMapping(typeof(ExampleClass));
        ...
        {
            var classMap = new ClassMapping(typeof(ExampleClass)) { Name = "class1" };
            classMap.AddSubclass(new SubclassMapping(typeof(ExampleClass)));
