...
namespace FluentNHibernate.Testing.ConventionsTests.AcceptanceCriteria
{
    ...
    public class PropertyAcceptanceCriteriaIsAnyTests
    {
        ...
        public void IsAnyMatchesAnyOfTheSuppliedValues()
        {
            ...
            acceptance
                .Matches(new PropertyInspector(new PropertyMapping(null) { Access = Access.Field.ToString()}))
                .ShouldBeTrue();

            acceptance
                .Matches(new PropertyInspector(new PropertyMapping(null) { Access = Access.Property.ToString() }))
                .ShouldBeTrue();
        }
        ...
        public void IsAnyFailsIfNoValuesMatch()
        {
            ...
            acceptance
                .Matches(new PropertyInspector(new PropertyMapping(null) { Access = Access.CamelCaseField().ToString() }))
                .ShouldBeFalse();
        }
